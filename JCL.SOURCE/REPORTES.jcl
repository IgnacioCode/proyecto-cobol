//REPORTES JOB (UNLAM),'REPORTES DB2',CLASS=A,MSGCLASS=H,
//         NOTIFY=&SYSUID
//*
//*==============================================================*
//* COMPILA, BINDEA Y EJECUTA REPORTES                          *
//* SUBSISTEMA: DBDG                                            *
//* ENTRADA : KC03G24.GRUPO6.DATA.INPUT4                        *
//* REPORTE : KC03G24.GRUPO6.REPORTES.OUTPUT4                   *
//* INPUT4  : RECFM=FB,LRECL=80                                 *
//* OUTPUT4 : RECFM=FB,LRECL=133                                *
//*==============================================================*
//SETPROG  SET PROG=REPORTES
//*
//*--------------------------------------------------------------*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DELETE KC03G24.GRUPO6.REPORTES.OUTPUT4
  SET MAXCC = 0
/*
//*
//*--------------------------------------------------------------*
...
//SYSPRINT DD SYSOUT=*
//SYSUDUMP DD SYSOUT=*
//ENTRADA  DD DSN=KC03G24.GRUPO6.DATA.INPUT4,DISP=SHR
//REPORTE  DD DSN=KC03G24.GRUPO6.REPORTES.OUTPUT4,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(RECFM=FB,LRECL=133,BLKSIZE=1330),
//            SPACE=(TRK,(5,5)),UNIT=SYSALLDA
//SYSTSIN  DD *
  DSN SYSTEM(DBDG)
  BIND PLAN(GRUPO6) MEMBER(REPORTES) -
       ACTION(REPLACE) ISOLATION(CS) ENCODING(EBCDIC)
  RUN PROGRAM(REPORTES) PLAN(GRUPO6) -
